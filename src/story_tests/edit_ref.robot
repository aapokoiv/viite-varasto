...
Edit Article With Correct Inputs And Optional Fields
    Create New Reference And Navigate To List Page
    Edit Reference  article  art-kw  testAuthor1  testTitle1  2024  journal=journal  volume=1  pages=32-34
    No Error Messages

Edit Book With Correct Inputs And Optional Field
    Create New Reference And Navigate To List Page
    Edit Reference  book  book-kw  testAuthor1  testTitle1  2024  publisher=publisher
    No Error Messages

Edit Inproceedings With Correct Inputs And Optional Field
    Create New Reference And Navigate To List Page
    Edit Reference  inproceedings  inprc-kw  testAuthor1  testTitle1  2024  booktitle=booktitle
    No Error Messages
...
Edit Reference
    [Arguments]  ${type}  ${keyword}  ${author}  ${title}  ${year}  ${journal}=None  ${volume}=None  ${pages}=None  ${publisher}=None  ${booktitle}=None
    Fill Edit Form  ${type}  ${keyword}  ${author}  ${title}  ${year}  ${journal}  ${volume}  ${pages}  ${publisher}  ${booktitle}
    Submit Edit