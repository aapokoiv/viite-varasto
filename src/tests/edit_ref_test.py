...
class TestEditRef(unittest.TestCase):
    ...
    def test_update_author_successfully(self):
        ...
        with app.app_context():
            ...
            update_ref(ref_id, "article", "test_kw", "Jane Smith", "Original Title", 2020)
    ...
    def test_update_title_successfully(self):
        ...
        with app.app_context():
            ...
            update_ref(ref_id, "article", "test_kw", "John Doe", "New Title", 2020)
    ...
    def test_update_year_successfully(self):
        ...
        with app.app_context():
            ...
            update_ref(ref_id, "article", "test_kw", "John Doe", "Original Title", 2021)
    ...
    def test_update_keyword_successfully(self):
        ...
        with app.app_context():
            ...
            update_ref(ref_id, "article", "new_kw", "John Doe", "Original Title", 2020)
    ...
    def test_update_all_fields_successfully(self):
        ...
        with app.app_context():
            ...
            update_ref(ref_id, "misc", "new_kw", "Jane Smith", "Updated Title", 2021)
